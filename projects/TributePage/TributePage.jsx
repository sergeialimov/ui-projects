...
const TributePage = () => (
  <div className="tribute-page__main">
    ...
    <div className="tribute-page__image-wrapper">
      <img className="tribute-page__image" src="https://c2.staticflickr.com/4/3689/10613180113_fdf7bcd316_b.jpg" alt="tribute page" />
    ...
    <div className="tribute-page__biography">
      ...
      <ul className="tribute-page__list">
        ...
        <li className="tribute-page__list-item">
          ...
          {' '}
          {
          `- Leaves his family's farm to attend the University of Minnesota, thanks to a Depression
        ...
        <li className="tribute-page__list-item">
          ...
          {' '}
          {
          `- Has to stop school and save up more money. Works in the Civilian Conservation Corps,
          helping starving Americans. "I saw how food changed them", he said. "All of this left
          scars on me."`
          }
        </li>
        <li className="tribute-page__list-item">
        ...
        <li className="tribute-page__list-item">
          ...
          {' '}
          {
          `- Marries wife of 69 years Margret Gibson. Gets laid off due to budget cuts. Inspired by
        ...
        <li className="tribute-page__list-item">
          ...
          {' '}
          {
          `- Rejects a 100% salary increase from Dupont, leaves behind his pregnant wife, and flies
          to Mexico to head a new plant pathology program. Over the next 16 years, his team breeds
          6,000 different strains of disease resistent wheat - including different varieties for
        ...
        <li className="tribute-page__list-item">
          ...
          creating a strain that responds well to fertalizer. It goes on to provide 95% of Mexico's
          wheat.`
          }
        </li>
        <li className="tribute-page__list-item">
          ...
          {' '}
          {
          `- Visits Delhi and brings his high-yielding strains of wheat to the Indian subcontinent
        ...
        <li className="tribute-page__list-item">
          ...
          that GM crops are not inherently dangerous because "we've been genetically modifying
          plants and animals for a long time. Long before we called it science, people were
